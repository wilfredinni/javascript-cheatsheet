...
<template>
  <section>
    <prose>
      <h1
        class="mb-4 bg-gradient-to-r from-indigo-400 to-green-400 bg-clip-text text-center font-display text-4xl font-medium tracking-tight text-transparent dark:from-green-400 dark:via-teal-300 dark:to-green-300 sm:text-start"
      >
