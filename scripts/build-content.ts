...
function replaceCustomBlocks(content: string) {
  return content
    ...
    .replace(
      ...
      '<div class="dark:!prose-code:text-zinc-300 prose mt-2.5 text-amber-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:!text-amber-900 prose-a:decoration-amber-600 prose-a:decoration-2 prose-a:underline-offset-0 prose-code:text-amber-900 dark:text-zinc-300 dark:prose-a:!text-amber-400"><p>',
    )
    ...
    .replace(
      ...
      '<div class="prose mt-2.5 text-amber-800 [--tw-prose-background:theme(colors.amber.50)] [--tw-prose-underline:theme(colors.amber.400)] prose-a:text-amber-900 prose-code:text-amber-900 dark:text-zinc-300 dark:[--tw-prose-underline:theme(colors.amber.700)] dark:prose-code:text-zinc-300"><p>',
    )
