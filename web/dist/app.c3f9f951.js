...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/atom-one-light.min.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
},{}],"js/toc.js":[function(require,module,exports) {
"use strict";
...
function insertIndex(div, title) {
  for (var item in title) {
    var index = "<li><a href=\"\">".concat(title[item].innerText, "</a></li>");
...
require("../css/atom-one-light.min.css");
