        ...
        >
          ...
          >
            <button
              ...
              :class="
                hasNext ? 'hover:text-amber-500 dark:hover:text-amber-500' : ''
              "
              @click="increaseFont"
            >
              A+
          ...
          <button
            class="rounded text-zinc-400 transition duration-300 hover:text-amber-500 dark:hover:bg-transparent"
            @click="reader.toggle()"
          >
