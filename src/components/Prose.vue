...
<template>
  <div
    :class="[
      ...
      // table
      'overflow-x-auto prose-thead:leading-6 prose-th:font-semibold prose-th:text-zinc-700 prose-td:font-mono prose-td:font-bold prose-td:leading-6 prose-td:text-amber-500 prose-th:dark:text-zinc-300 prose-td:dark:text-amber-400',
      // code
      'prose-code:text-amber-500 prose-code:dark:text-amber-400',
      // reader
